...
var block_logo = '<div id="rad_block_logo" align="center"><a href="" target="_blank" title="audio-player js"><img src="" border="0" id="rad_logo" alt=""></a></div>';
...
if (g_rad_player_width<=430){
    document.getElementById('rad_player').style.height = '200px';
    document.getElementById('rad_block_logo').style.width = '70%';
    document.getElementById('rad_block_logo').style.borderTop = '1px solid #ffffff';
...
if (g_rad_player_width<=300){
    ...
    document.getElementById('rad_list').style.marginLeft = '50px';
    ...
    document.getElementById('rad_stationname').style.width = '200px';
...
function rad_show_stations(){
  	...
  	if (win_height - document.getElementById('rad_player').getBoundingClientRect().bottom > 220){
  		...
  		document.getElementById('rad_list').style.marginTop='-'+(rad_stations.length*0)+'px'; //позиция плейлиста
  	}
